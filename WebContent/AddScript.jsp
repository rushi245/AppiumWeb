            ...
            <div class="container-fluid">
                ...
                <form class="form-group">
				    <div class="form-group">
				      ...
				      <div class="row">
				      <div class="col-sm-6">
				      <input type="text" class="form-control rounded-border" id="txtScriptName" placeholder="Enter Application Name">
				      </div>
				      </div>
				    </div>
				    <div class="form-group">
				      ...
				      <div class="row">
				      <div class="col-sm-6">
				      <input type="text" class="form-control rounded-border" id="txtPakgName" placeholder="Enter Package Name">
				      </div>
				      </div>
				    </div>				    
				      ...
				      <div class="row">
				        <div class="col-lg-6 col-sm-6 col-12">
				            <div class="input-group">
				                ...
				                <input type="text" id="txtClassName" placeholder="Select Script Class File" class="form-control rounded-border" readonly>
				            </div>
				        </div>	
				      </div>
				    </div>  
				      ...
				      <div class="row">
				        <div class="col-lg-6 col-sm-6 col-12">
				            <div class="input-group">
				                ...
				                <input type="text" id="txtAPKName" placeholder="Select APK File" class="form-control rounded-border" readonly>
				            </div>
				        </div>	
				      </div>
				    </div>  
